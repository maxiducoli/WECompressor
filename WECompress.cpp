// WECompress.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CWECompress message handlers


void CWECompress::InitTree(void)  // initialize trees 
{
	UINT i;
...
void CWECompress::InsertNode(UINT r)	
{
	UINT next_r, c;
...
void CWECompress::DeleteNode(UINT r)
{
	if (prev[r] == N) 
		return;
	next[prev[r]] = next[r];
...
void CWECompress::LocateNode(UINT r, UINT *match_len, UINT *match_pos)
{
	UINT p, c, i;
...
BOOL CWECompress::Compress(BYTE **BufDest, BYTE *BufSrc, ULONG *SizeResult, ULONG SizeSrc)
{
	BYTE *ptrRes = *BufDest;
...
BOOL CWECompress::DeCompress(BYTE **BufDest, BYTE *BufSrc)
{	
	BYTE *ptrRes = *BufDest;
...
LONG CWECompress::FindCompressedLength(BYTE *BufSrc)
{
	LONG k3,counter;
	ULONG i,j;
	BYTE k,k2;
